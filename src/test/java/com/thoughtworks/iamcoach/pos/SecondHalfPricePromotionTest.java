...
public class SecondHalfPricePromotionTest {
  ...
  public void calculate_test() {
    ...
    assertThat(secondHalfPricePromotion.calculate(boughtItem)).isEqualTo(40.0);

    BoughtItem boughtItem1 = new BoughtItem(item, 3.0);
    assertThat(secondHalfPricePromotion.calculate(boughtItem1)).isEqualTo(25.0);

    BoughtItem boughtItem2 = new BoughtItem(item, 1.0);
    assertThat(secondHalfPricePromotion.calculate(boughtItem2)).isEqualTo(10.0);

    BoughtItem boughtItem3 = new BoughtItem(item, 0.0);
    assertThat(secondHalfPricePromotion.calculate(boughtItem3)).isEqualTo(0.0);
  }
}
